                ...
                <DialogBody className="">
                    <div className="mb-3">
                        <input
                            ...
                            className='bg-gray-50 border text-black border-gray-400 px-2 py-2 w-full rounded-md outline-none placeholder-gray-600'
                    ...
                    <div className="mb-3">
                        <input
                            ...
                            className='w-full bg-gray-50 border text-black border-gray-400 px-2 py-2  rounded-md outline-none placeholder-gray-600'
