        ...
        <Layout>
            <div className=" container mx-auto px-4 py-5 lg:py-8">
                ...
                <div className="top ">
                    ...
                    <div className=" bg-gray-100 py-5 rounded-xl border shadow-sm shadow-blue-gray-100">
                            ...
                            return (
                                <div key={index}>
                                    {order.cartItems.map((item, index) => {
                                        ...
                                        const { status } = order
                                        return (
                                            <div key={index} className="mt-5 flex flex-col overflow-hidden rounded-xl  md:flex-row bg-gray-100">
                                                
                                                <div className="w-full border-r border-gray-100 bg-gray-200 md:max-w-xs">
